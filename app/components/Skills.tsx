    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {t.skills.drinks.map((drink, i) => (
            <Reveal
              key={drink.name}
              delay={(i % 4) * 80}
              className="group relative flex flex-col rounded-2xl border border-gold/15 bg-surface p-6 transition-all duration-300 hover:-translate-y-1 hover:border-gold/40 hover:shadow-[var(--shadow-glow)]"
            >
              <div className="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-gold/10 text-gold transition-colors group-hover:bg-gold group-hover:text-night">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-[1fr_1.2fr]">
          <Reveal className="rounded-2xl border border-gold/20 bg-gradient-to-br from-surface-2 to-surface p-8">
          ...
          <Reveal delay={120} className="rounded-2xl border border-gold/15 bg-surface p-8">
